...
class CryptoController extends Controller 
{
    ...
    {    
        // return 33;      
        $rules = [
            'coin_title' => 'bail|required|string|unique:crypto_coins_list,coin_title',
            'coin_code' => 'bail|required|string|unique:crypto_coins_list,coin_code',
            'coin_image' => 'bail|file',
            'coin_tc' => 'bail|string',
    ...
    public function updateCryptoCoin(Request $request, CryptoModel $CryptoModel, $id)
    {
            ...
            $rules = [
                'coin_title' => 'bail|string|unique:crypto_coins_list,coin_title',
                'coin_code' => 'bail|string|unique:crypto_coins_list,coin_code',
                'coin_image' => 'bail|file',
                'coin_tc' => 'bail|string',
                'is_available' => 'bail|boolean',
                'is_new' => 'bail|boolean',
